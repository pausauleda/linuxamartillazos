 ...
 *   entirety and paste it here, changing the prefix from theme_ to linuxamartillazos_.
 *   For example:
 *
 *     original: theme_breadcrumb()
 *     theme override: linuxamartillazos_breadcrumb()
 *
 *   where linuxamartillazos is the name of your sub-theme. For example, the
...
function linuxamartillazos_preprocess_html(&$variables, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function linuxamartillazos_preprocess_page(&$variables, $hook) {
  $variables['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function linuxamartillazos_preprocess_comment(&$variables, $hook) {
  $variables['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function linuxamartillazos_preprocess_block(&$variables, $hook) {
